...
metadata {
	definition (name: "TV Lift", author: "dfry") {
		capability "Switch"
		command "hello"
		command "goodbye"
	...
	tiles {
		...
		standardTile("greeting", "device.greeting", width: 1, height: 1, canChangeIcon: true, canChangeBackground: true) {
			state "default", label: 'UP', action: "switch.off", icon: "st.thermostat.thermostat-up", backgroundColor: "#ccccff"
		} 
		standardTile("greeting2", "device.greeting", width: 1, height: 1, canChangeIcon: true, canChangeBackground: true) {
			state "default", label: 'Down', action: "switch.on", icon: "st.thermostat.thermostat-down", backgroundColor: "#ccccff"
		} 
        /*
		standardTile("greeting", "device.greeting", width: 1, height: 1, canChangeIcon: true, canChangeBackground: true) {
       ...
       */
		...
		main "switch"
		details(["switch","greeting","greeting2","message"])
	}
    simulator {
